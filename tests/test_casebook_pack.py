"""Regression checks for the ember-chain-oracle-flow casebook."""
...
from casebook.harness import assert_expected, ember_chain_oracle_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_chain_oracle_flow_summary(), assert_expected())
